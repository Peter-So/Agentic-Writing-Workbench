...
NOVEL_STAGE_PROFILES: dict[str, dict[str, Any]] = {
    "concept": {
        ...
        "flow": "planning_light",
        "node_flow": ["request_analyze", "draft_assemble", "generate", "model_review", "draft_finalize"],
    ...
    "outline": {
        ...
        "node_flow": ["request_analyze", "draft_assemble", "generate", "model_review", "draft_finalize", "archive"],
    ...
    "prose": {
        ...
        "node_flow": [
            "request_analyze", "draft_assemble", "generate",
